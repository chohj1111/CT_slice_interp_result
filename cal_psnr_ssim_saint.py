...
out_dir = 'C:\Results\CT_slice_interp\SAINT\kits_RFN_load_KH'
...
for case in case_ids:
    case_id_only = case.replace('_x5_R.nii.gz', '', 1)
    
    output_img = nib.load(os.path.join(out_dir, case, 'imaging_1mm.nii.gz'))
