...
# out_dir = 'C:/PythonProjects/CT_slice_interp/SAINT/experiment/RPLHR_RFN_load/results/nifti'
...
for case in case_ids:
    ...
    gt_img = nib.load(os.path.join(gt_dir, case_id_only))
    gt = gt_img.get_fdata()
...
f = open(os.path.join('SAINT', 'metrics.txt'), "w+")
