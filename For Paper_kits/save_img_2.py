...
img_clip = np.clip(img_gt[109], lower_bound, upper_bound)
...
img_clip = np.clip(img_ours[109], lower_bound, upper_bound)
...
# saint
img_clip = np.clip(img_saint[109], lower_bound, upper_bound)
img_norm = (img_clip - lower_bound) / (upper_bound - lower_bound)
...
# incremental
img_clip = np.clip(img_incremental[109], lower_bound, upper_bound)
img_norm = (img_clip - lower_bound) / (upper_bound - lower_bound)
...
# da-vsr
img_clip = np.clip(img_davsr[109], lower_bound, upper_bound)
img_norm = (img_clip - lower_bound) / (upper_bound - lower_bound)
...
# tvsrn
img_clip = np.clip(img_tvsrn[109], lower_bound, upper_bound)
img_norm = (img_clip - lower_bound) / (upper_bound - lower_bound)
...
# Bicubic
img_clip = np.clip(img_bicubic[109], lower_bound, upper_bound)
img_norm = (img_clip - lower_bound) / (upper_bound - lower_bound)
