...
img_clip = np.clip(img_gt[221], lower_bound, upper_bound)
...
img_clip = np.clip(img_ours[221], lower_bound, upper_bound)
...
# saint
img_clip = np.clip(img_saint[221], lower_bound, upper_bound)
img_norm = (img_clip - lower_bound) / (upper_bound - lower_bound)
...
# incremental
img_clip = np.clip(img_incremental[221], lower_bound, upper_bound)
img_norm = (img_clip - lower_bound) / (upper_bound - lower_bound)
...
# da-vsr
img_clip = np.clip(img_davsr[221], lower_bound, upper_bound)
img_norm = (img_clip - lower_bound) / (upper_bound - lower_bound)
